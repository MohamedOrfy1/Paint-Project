...
public class Triangle extends Implementation{
  Point point2;
  Point point3;
  int [] y;
  int[] x;
  ...
  @Override
    public String toString(){
        ...
        return "Triangle " + TriangleProp.TN;
    }   
    ...
    @Override
    public Point resize(Point cornerpoint, Point draggedPoint) {
        Point[] points=getPoint();
        if (points[0].equals(cornerpoint)) {
            super.setPosition(draggedPoint);
            return getPoint()[0];
        }
