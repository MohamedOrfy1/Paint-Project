...
public class Colorize extends javax.swing.JFrame {
    ...
    private Shape s;
    public Colorize(Paint_window P,Shape s) {
        initComponents();
        this.p=P;
        this.s=s;
    ...
    private void initComponents() {
        ...
        jButton1.setText("Choose border color");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      Color fillColor=JColorChooser.showDialog(null, "Choose border color", Color.black);
      myDrawingPanel p1 = p.getPanel1();
      p1.refresh(null);
      this.s.setFillColor(fillColor);
      this.setVisible(false);
      p.setVisible(true);
